...
vector< vector<string>> allmetrics = {{"Tool", "#SVs_bench", "#SVs_user", "#SVs_filtered_user", "#TP", "#FP", "#FN", "#LP", "SeqSim", "Recall", "Precision", "F1 score"}};
...
string shortSVFilename = "short_sv_reg.bed";
