...
## result description
The following benchmarking results were generated by using ASVBM version 1.3.0, and the latest version is recommended and the results are not shown again in current page.
<table>
  <thead>
    <tr>
      <th>SV caller</th>
